...
#define NO_PI   ALGR(NO_P)               // π
#define NO_OMEG ALGR(NO_W)               // Ω
#define NO_BETA ALGR(NO_S)               // ß
#define NO_SIGM ALGR(S(NO_S))            // ∑
#define NO_DELT ALGR(S(NO_D))            // ∆
#define NO_CDOT ALGR(NO_Q)               // •
#define NO_DEGS ALGR(S(NO_Q))            // °
#define NO_MICR ALGR(NO_Y)               // µ

#define NO_OE   ALGR(NO_O)               // œ
#define NO_FRC  ALGR(NO_C)               // ç
#define NO_ACTE ALGR(NO_E)               // é
