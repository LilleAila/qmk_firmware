...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
            ...
            //
            KC_TAB, LT(2, KC_ENT), KC_DEL, /**/ KC_BSPC, LT(1, KC_SPC), KC_ESC
            ),
    ...
    [3] = LAYOUT_split_3x6_3( // Function
            QK_BOOT, DF(0),   DF(4),   _______, _______, _______, /**/ KC_MPRV, KC_MNXT, KC_VOLU, KC_BRIU, _______, KC_SLEP,
    ...
    [4] = LAYOUT_split_3x6_3( // Gaming (almost qwerty)
